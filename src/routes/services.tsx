...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>Services — Farawi Events Dubai</title>
        <meta name="description" content="Explore Farawi Events services: event management, parties, entertainment and luxury hospitality in Dubai." />
        <meta property="og:title" content="Our Services — Farawi Events" />
        <meta property="og:description" content="Bespoke event production, party design, entertainment and five-star hospitality." />
      </Helmet>
      ...
      <section className="section-padding container-luxe space-y-16">
        {services.map((s, i) => (
          ...
          >
            <Link to={`/services/${s.slug}`} className="block overflow-hidden aspect-[4/3] group">
            ...
            <div>
              ...
              <Link to={`/services/${s.slug}`} className="btn-outline-gold mt-8">
